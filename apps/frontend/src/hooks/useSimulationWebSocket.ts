...
export function useSimulationWebSocket(
  ...
  const handleMessage = useCallback((event: MessageEvent) => {
    try {
      ...
      switch (message.type) {
        case 'FullState':
          console.log('Received FullState update', { tick: message.tick, antsCount: message.ants.length })
          setData({
        ...
        case 'DeltaUpdate':
          console.log('Received DeltaUpdate', { 
            tick: message.tick, 
        ...
        case 'SimulationStatus':
          console.log('Received SimulationStatus', { 
