...
import { desc, postgres_db, schema } from '@ant-colony-simulator/db-drizzle'
import { Button } from '~/lib/components/ui/button'
import { CreateSimulationButton } from '~/lib/components/create-simulation-button'
  ...
  return (
    <div className="mx-auto max-w-5xl flex-1 space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Ant Colony Simulator</h1>
          <p className="text-muted-foreground text-sm mt-1">
            Create and watch ant colony simulations
          </p>
        </div>
